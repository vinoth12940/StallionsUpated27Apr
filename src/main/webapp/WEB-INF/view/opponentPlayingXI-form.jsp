									...
									<div class="col-md-12">
										<div class="table-responsive">
											<table id="tournamentTable" class="table table-striped">
												...
												<tbody>
													<form:form action="saveOpponentPlayingXIDetails" modelAttribute="pojoForm" method="POST" class="form-horizontal">
													<c:forEach var="matchplayingxi" items="${pojoForm.pojos}" varStatus="status">
														<tr>
															<td><form:input type="text" path="pojos[${status.index}].batting_Order"
																	id="batting_Order" class="form-control"
																	placeholder="batting_Order" /></td>
															 <td><form:input type="text" path="pojos[${status.index}].players_Name"
																	id="players_Name" class="form-control"
																	placeholder="players_Name" /></td> 
															<td><form:checkbox path="pojos[${status.index}].is_Captain" id="is_Captain"
																	value="Y" /></td>
															<td><form:checkbox path="pojos[${status.index}].is_Wicket_Keeper" id="is_Wicket_Keeper"
																	value="Y" /></td>
															<td><form:input type="hidden"
																		path="pojos[${status.index}].isStallionsDetails"
																		id="isStallionsDetails" class="form-control"
																		placeholder="isStallionsDetails" value="N"/></td>		
														</tr>
														</c:forEach>
													</form:form>
												</tbody>
						...
						<div class="box">
							<div class="col-lg-12">
									...
									<div class="col-lg-6">
										...
										<a href="${pageContext.request.contextPath}/matchPlayingXI/stallionsScoreCard">Next</a>	
									</div>
								</div>
								<p>
